...
def main():
    ...
    peugeot_logo = reducir_tamaño(peugeot_logo)

    # Convertir a escala de grises
    gray_maserati = cv2.cvtColor(maserati_logo, cv2.COLOR_BGR2GRAY)
    gray_peugeot = cv2.cvtColor(peugeot_logo, cv2.COLOR_BGR2GRAY)
    ...
    mostrar_contornos(maserati_logo, contornos_maserati, 'Contorno Logo Maserati')
    mostrar_contornos(peugeot_logo, contornos_peugeot, 'Contorno Logo Peugeot')

    # Imprimir las coordenadas de los contornos
    imprimir_coordenadas(contornos_maserati, 'Maserati')
    imprimir_coordenadas(contornos_peugeot, 'Peugeot')
