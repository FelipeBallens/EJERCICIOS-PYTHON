...
if Eleccion==1:
    ...
    Altura = float(input("\nDigite el valor de la altura del prisma (m): "))
    Vprisma = Base * Altura 
    ...
    Altura = float(input("\nDigite la altura de la piramide (m): "))
    ...
    print("\n****************************************************************")
    print("\nCONO TRUNCADO\n")
    Altura = float(input("\nDigite la altura del cono truncado (m): "))
    Radio1 = float(input("\nDigite el radio de la base del cono (m): "))
    Radio2 = float(input("\nDigite el radio de la punta del cono (m): "))
    ...
    print("\n****************************************************************\n")
     ...
     print("\n****************************************************************")
     print("\nCILINDRO\n")
     Altura = float(input("\nDigite la altura del cilindro (m): "))
     Radio1 = float(input("\nDigite el radio del cilindro (m): "))
